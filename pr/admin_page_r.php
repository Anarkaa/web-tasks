    ...
    $dbhost = 'localhost';
         ...
         if(! $conn ){
          ...
          if(isset($_GET['delete'])){
             $sql = "DELETE FROM r WHERE ID=".$_GET['delete'];
...
<html>
  ...
  <?php
    ...
    <div class="">
      ...
      <div class=""><a href="admin_page_r.php?delete='.$row['ID'].'">Delete</a></div>
      </div>
    </div>
        </div>';
    }
    ...
    mysqli_close($conn);
?>
  <form action="admin_page_r.php" style="margin-right: 50px">
      <h1>Admin Page</h1>
      <table>
            <tr>
                <td>Image(URL): </td>
